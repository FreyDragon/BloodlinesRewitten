...
import endermanfrey.bloodlinesrewritten.procedures.TriggerAbility2Procedure;
...
public class Ability2Message {
	...
	public static void pressAction(Player entity, int type, int pressedms) {
		...
		if (type == 0) {
			...
			TriggerAbility2Procedure.execute(entity);
		}
	}

	@SubscribeEvent
	public static void registerMessage(FMLCommonSetupEvent event) {
		BloodlinesRewrittenMod.addNetworkMessage(Ability2Message.class, Ability2Message::buffer, Ability2Message::new, Ability2Message::handler);
	}
}
